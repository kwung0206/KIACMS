...
function getTitleFromPath(pathname) {
  ...
  if (pathname.startsWith("/student/notes/") && pathname.endsWith("/edit")) return "노트 수정";
  if (pathname.startsWith("/student/notes/new")) return "노트 작성";
  if (pathname.startsWith("/student/notes/")) return "노트 상세";
  if (pathname.startsWith("/student/notes")) return "내 노트";
  ...
  if (pathname.startsWith("/instructor/tagged-notes")) return "태그된 노트";
  if (pathname.startsWith("/instructor/project-mentoring")) return "프로젝트 멘토 지원";
  ...
  if (pathname.startsWith("/root/projects")) return "프로젝트 관리";
